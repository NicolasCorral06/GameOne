...
<body>
    ...
    $sqlprod = "SELECT id_produtos, imgpq, nome, preco FROM produtos WHERE tipo_produto_macro = 'Nintendo'";
    ...
    <header class="header">
        <div class="container">
            <div class="logo">
                <a href="../index.php"><img src="../assets/imgs/logonin.png"></a>
            </div>
            <nav class="menu">
                <div class="head">
                    <div class="logo">
            ...
            <div class="header-right">
                <button type="button" class="search icon-btn" onclick="mostrbar()">
                    <i class="fa-solid fa-search" style="color: #fd0000;">
                        <form action="pesquisa.php" method="get" style="display:none;" id="barraap">
                            <input type="text" name="pesquisa" id="">
                        </form>
                    </i>
                </button>
                <button type="button" class="cart icon-btn"><a href="carrinho.php"><i class="fa-solid fa-shopping-cart" style="color: #fd0000;"></i></a></button>
                <button type="button" class="user icon-btn"><a href="acessar.php"><i class="fa-solid fa-user" style="color: #fd0000;"> </a></i></button>
    ...
    <div class="container-fluid" style="padding-left: 0; padding-right: 0;">
        <div class="row topoNintendo" style="background-color: red; height: 100vh;">
            <div class="col-sm-12 col-md-12 col-lg-5 col-xl-5">
                <h1 style="color: #fff; font-size: 7em; margin-top:20%;">Nintendo</h1><br>
                <p style="font-size: large; font-weight: bold; font-family: Arial, Helvetica, sans-serif;">Nossa loja de games agora é parceira autorizada da Nintendo. <br>
                    Agora você já sabe quem procurar se quiser economizar!</p><br><br>
                <a href="#banner" class="btnnintendo"> Veja Mais</a>
            </div>
            <div class="col-sm-12 col-md-12 col-lg-7 col-xl-7"><img src="../assets/imgs/marionin.png"></div>
        </div>

        <div class="banner" id="banner">
            <img src="../assets/imgs/backnin3.jpg" alt="backx" class="img2">
            <div class="centerx row" id="mario">
                <div class="col-12">
                    <h1>O Melhor da Nintendo Para Você</h1>
                </div>
                <div class="col-12">
                    <p>Aqui você encontra a diversidade que procurava!</p>
                </div>
                <div class="imagens col-sm-12 col-md-6 col-lg-4 col-xl-4"><img src="../assets/imgs/jogonin1.png" style="height: 300px;">
                </div>
                <div class="imagens col-sm-12 col-md-6 col-lg-4 col-xl-4"><img src="../assets/imgs/jogonin2.png" style="height: 300px;">
                </div>
                <div class="imagens col-sm-12 col-md-6 col-lg-4 col-xl-4"><img src="../assets/imgs/jogonin3.png" style="height: 300px;">
                </div>
                <div class="imagens col-sm-12 col-md-6 col-lg-4 col-xl-4"><img src="../assets/imgs/jogonin4.png" style="height: 300px;">
                </div>
                <div class="imagens col-sm-12 col-md-6 col-lg-4 col-xl-4"><img src="../assets/imgs/jogonin5.png" style="height: 300px;">
                </div>
                <div class="imagens col-sm-12 col-md-6 col-lg-4 col-xl-4"><img src="../assets/imgs/jogonin6.png" style="height: 300px;">
                </div>
                <div class="col-12">
                    <center>
                        <br><br><br>
                        <a class="btnplay" href="#cardTotal" style="color: #e62521">Saiba Mais</a>
                        <br><br><br>
                    </center>
                </div>
            </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-10">
                        ...
                        <div class="row">
                            <h4 class="form-group col-xs-3">Jogos Nintendo</h4>
            ...
            <div class="container">
                <div class="wrapper">
                    <div class="footer-widget">
                        <a href="#">
                            <img src="../assets/imgs/logorespnin.png" class="logo">
                        </a>
                        <p class="desc">
