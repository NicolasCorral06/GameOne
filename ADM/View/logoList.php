...
<head>
    ...
    <script>
        function confirmDelete(id){
            ...
            if(resp == true){
                location.href="../Controller/admController.php?logo_delete=1&id=" + id;
            } else {
                return null;
            }
        }
...
<div class="text">Logout</div>
        ...
        <div class="row">
            ...
            if(isset($dados["num"])){
                for($i = 1;$i <= $dados["num"]; $i++){
                    ...
                    echo "<td data-label='IMG PQ'>". $dados[$i]["imgpq"] . "</td>";
                    echo "<td data-label='IMG GD'>". $dados[$i]["imggd"] . "</td>";
                    echo "<td data-label='MENU'>". $dados[$i]["menu_logo"] . "</td>";
                    ...
                    echo "<td>";
                        ...
                        ?>
                            <button onclick="confirmDelete(<?= $dados[$i]['id']; ?>)" class="btnDel button1"> Deletar </button>
                        <?php
                        echo "</td>";
                        echo "</tr>";
                }
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h5 style="margin-top: 2.5%; margin-left: 2%;">Novo Logotipo</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Fechar">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                    <form action="../Controller/admController.php" method="post" name="LogoNew" enctype="multipart/form-data">
    <input type="hidden" name="enviarImgLogo" value="1">
    ...
    <label for="menu_logo">Menu</label>
    <select name="menu_logo"><br>
