...
<head>
    ...
    <title>Xbox - Usuário</title>
    <link rel="stylesheet" href="../css/cssxboxcorrig.css">
...
<body>
    ...
    $sqlprod = "SELECT id_produtos, imgpq, nome, preco FROM produtos WHERE tipo_produto_macro = 'Xbox'";
    ...
    <header class="header">
        <div class="container">
            <div class="logo">
                <a href="../index.php"><img src="../assets/imgs/logox.png"></a>
            </div>
            <nav class="menu">
                <div class="head">
                    <div class="logo">
                        <a href="../index.php"><img src="../assets/imgs/logorespxbx.png"></a>
            ...
            <div class="header-right">
                ...
                <button type="button" class="cart icon-btn"><a href="carrinho.php"><i class="fa-solid fa-shopping-cart" style="color: #028d4a;"></i></a></button>
                <button type="button" class="user icon-btn"><a href="acessar.php"><i class="fa-solid fa-user" style="color: #028d4a;"> </a></i></button>
    ...
    <div class="container-fluid" style="padding-left: 0; padding-right: 0;">
        <div class="row topoXbox" style="background-color: #028d4a; height: 100vh;">
            <div class="col-sm-12 col-md-12 col-lg-5 col-xl-5">
                <h1 style="color: #fff; font-size: 5em; margin-top:25%;">Xbox</h1><br>
                <p style="font-size: large; font-weight: bold; font-family: Arial, Helvetica, sans-serif;">Vocês pediram e nós atendemos. Agora temos alguns dos melhores produtos para aproveitar em seu XBOX, o Live Gold, Gift Card, Game Pass e mais.</p><br><br>
                <a href="#banner" class="btnxbox"> Veja Mais</a>
            </div>
            <div class="col-sm-12 col-md-12 col-lg-7 col-xl-7"><img src="../assets/imgs/PersoX.png"></div>
        </div>

        <div class="banner" id="banner">
            <img src="../assets/imgs/backx.jpg" alt="backx" class="img2">
            <div class="centerx row" id="mario">
                <div class="col-12">
                    <h1>O Melhor do Xbox Para Você</h1>
                </div>
                <div class="col-12">
                    <p>Aqui você encontra a diversidade que procurava!</p>
                </div>
                <div class="imagens col-sm-12 col-md-6 col-lg-4 col-xl-4"><img src="../assets/imgs/jogox1.jpg" style="height: 300px;">
                </div>
                <div class="imagens col-sm-12 col-md-6 col-lg-4 col-xl-4"><img src="../assets/imgs/jogox2.jpg" style="height: 300px;">
                </div>
                <div class="imagens col-sm-12 col-md-6 col-lg-4 col-xl-4"><img src="../assets/imgs/jogox3.jpg" style="height: 300px;">
                </div>
                <div class="imagens col-sm-12 col-md-6 col-lg-4 col-xl-4"><img src="../assets/imgs/jogox4.jpg" style="height: 300px;">
                </div>
                <div class="imagens col-sm-12 col-md-6 col-lg-4 col-xl-4"><img src="../assets/imgs/jogox5.png" style="height: 300px;">
                </div>
                <div class="imagens col-sm-12 col-md-6 col-lg-4 col-xl-4"><img src="../assets/imgs/jogox6.jpg" style="height: 300px;">
                </div>
                <div class="col-12">
                    <center>
                        <br><br><br>
                        <a class="btnxbox" href="#cardTotal" style="color: green"> Saiba Mais</a>
                        <br><br><br>
                    </center>
                </div>
            </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-10">
                        ...
                        <div class="row">
                            <h4 class="form-group col-xs-3">Jogos Xbox</h4>
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        <div class="list-group">
                                            ...
                                            <a href="playstation.php" class="list-group-item">Jogos Playstation</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="container">
                <div class="wrapper">
                    <div class="footer-widget">
                        <a href="#">
                            <img src="../assets/imgs/logorespxbx.png" class="logo">
                        </a>
                        <p class="desc">
