                    ...
                    <tbody>
                        ...
                        <?php
                            for($i = 1;$i <= $dados["num"]; $i++){
                                echo "<tr>";
                                echo "<td data-label='ID'>". $dados[$i]["id_produtos"] . "</td>";
                                echo "<td data-label='NOME'>". $dados[$i]["nome"] . "</td>";
                                echo "<td data-label='PREÇO'>". $dados[$i]["preco"] . "</td>";
                                echo "<td data-label='MENU'>". $dados[$i]["tipo_produto_macro"] . "</td>";
                                echo "<td data-label='DESCRIÇÃO'><a href='visualizarProd.php?id=" . $dados[$i]["id_produtos"] . "' style='color: #20bc20; font-weight: 500;'>Visualizar</a></td>";
                        ...
                        ?>
                            ...
                            <form name="formEdit" action="prodEdit.php" method="post">
                                <input type="hidden" name="id" value="<?=$dados[$i]['id_produtos'];?>">
                                <input type="submit" name="sbmt" value="Editar" class="btnDel button1">
                            </form>
                                ...
                                ?>
                                <button onclick="confirmDelete(<?= $dados[$i]['id_produtos']; ?>)" class="btnDel button1">
                                    Deletar </button>
                                <?php
                                echo "</td>";
                                echo "</tr>";
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h5 style="margin-top: 2.5%; margin-left: 2%;">Novo Produto</h5>
        ...
        <option value="0"> Inativo </option>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal"
                            ...
                            <input type="submit" value="Enviar" name="sbmt"  class="btn btn-primary"
                            style="background-color: purple; border: none;" class="formBasico sbmt">
</form><br><br>  
                    </div>
                </div>
            </div>
