...
--
-- Host: 127.0.0.1
-- Tempo de geração: 29/11/2023 às 00:17
...
(8, 2, 43, 'Fire Emblem', 100.00, 3, 300.00, '2023-11-27 21:41:30', 'No carrinho', NULL),
(9, 2, 44, 'Red Dead Redemption II', 149.00, 1, 149.00, '2023-11-28 20:33:58', 'No carrinho', NULL),
(11, 2, 45, 'Animal Crossing: New Horizons Nintendo Switch', 332.00, 6, 1992.00, '2023-11-28 23:15:19', 'No carrinho', NULL);
...
--
ALTER TABLE `carrinhos`
  MODIFY `id_carrinho` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
